...
//		WebElement  v = driver.findElement(By.cssSelector("div.titulo-internas>h1"));
		return v != null;
	}
	
	public EmpresasListadasResultListPage clickOnTodasBtn() {
		WebDriver iFrameDriver = Util.switchTo(driver, "bvmf_iframe");
		WebElement todasBtn = iFrameDriver.findElement(By.xpath("//input[@type='button'][@value='Todas']"));
		todasBtn.click();
